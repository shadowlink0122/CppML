...
protected:
  void test() override {
    ...
    assertTrue(param0_after_first != param0_before,
               "First update should change parameters");
    assertTrue(param1_after_first != param1_before,
               "First update should change parameters");
    assertTrue(param0_after_second != param0_after_first,
               "Second update should further change parameters");
    assertTrue(param1_after_second != param1_after_first,
               "Second update should further change parameters");
  }
};
