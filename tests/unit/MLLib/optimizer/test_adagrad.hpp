...
protected:
  void test() override {
    ...
    assertNear(adagrad.get_learning_rate(), 0.01, 1e-9, "AdaGrad learning rate");
...
protected:
  void test() override {
    ...
    assertNear(adagrad1.get_learning_rate(), 0.01, 1e-9, "Default learning rate");
    
    // Test custom parameters
    optimizer::AdaGrad adagrad2(0.01, 1e-6);
    assertNear(adagrad2.get_learning_rate(), 0.01, 1e-9, "Custom learning rate");
