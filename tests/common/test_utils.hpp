...
protected:
   ...
   */
  template <typename T>
  void assertNotEqual(const T& not_expected, const T& actual,
                      const std::string& message = "");
   ...
   * @param message Error message if assertion fails
   */
  void assertNear(double expected, double actual, double tolerance = 1e-6,
                  const std::string& message = "");
...
template <typename T>
void MLLib::test::TestCase::assertEqual(const T& expected, const T& actual,
                                        const std::string& message) {
...
template <typename T>
void MLLib::test::TestCase::assertNotEqual(const T& not_expected,
                                           const T& actual,
                                           const std::string& message) {
...
template <typename T>
void MLLib::test::TestCase::assertVectorEqual(const std::vector<T>& expected,
                                              const std::vector<T>& actual,
                                              const std::string& message) {
...
template <typename ExceptionType, typename Func>
void MLLib::test::TestCase::assertThrows(Func func,
                                         const std::string& message) {
...
template <typename Func>
void MLLib::test::TestCase::assertNoThrow(Func func,
                                          const std::string& message) {
