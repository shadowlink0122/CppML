...
std::vector<MockGPUInfo> mockDetectGPUs(const MockSystemInfo& system) {
    ...
    if (mockCheckNVIDIAGPU(system.system_profiler_output)) {
        ...
        nvidia_gpu.name = mockDetectGPUName(GPUVendor::NVIDIA, system.system_profiler_output);
    ...
    if (mockCheckAMDGPU(system.system_profiler_output)) {
        ...
        amd_gpu.name = mockDetectGPUName(GPUVendor::AMD, system.system_profiler_output);
    ...
    if (mockCheckIntelGPU(system.system_profiler_output)) {
        ...
        intel_gpu.name = mockDetectGPUName(GPUVendor::INTEL_GPU, system.system_profiler_output);
    ...
    if (mockCheckAppleGPU(system.is_apple_silicon)) {
        ...
        apple_gpu.name = mockDetectGPUName(GPUVendor::APPLE, system.system_profiler_output);
...
int main() {
    ...
    for (const auto& system : test_systems) {
        ...
        bool correct = vendorToString(primary_vendor) == system.expected_primary_vendor;
